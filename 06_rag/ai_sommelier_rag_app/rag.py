...
# .env 읽기 함수
def _load_project_environment() -> None: # _ 언더스코어 붙는 이유: 프라이빗 의미
...
#------------------------------------------------------------------------------#
############# StrOutputParser()의 결과를 받아서 와인을 추천해주는 함수 ##################
...
#---------------------------------------------------------------------------------------#
##########search_wines 결과를 받아서 ChatPromptTemplate 만들어서 다시 StrOutputParser ##########
